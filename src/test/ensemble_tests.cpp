...
TEST_F(EnsembleFlowTest, DISABLED_DeferedNodesTriggeredBeforeNextOnes) {
    ConstructorEnabledModelManager managerWithDummyModel;
    config.setNireq(1);
    managerWithDummyModel.reloadModelWithVersions(config);
    ...
    EXPECT_THAT(order, ElementsAre(
                           ...
                           2,
                           3,
                           3));  // dummy_node_2 (deferred) gets executed before dummy_node_3 (next node after dummy_node_1)
